...
(function(global, factory) { /* global define, require, module */
    ...
    $root.Model = (function() {
         ...
         * @property {number|null} [score] Model score
         * @property {number|null} [min_score] Model min_score
         */
        ...
        Model.encode = function encode(message, writer) {
            ...
            if (message.min_score != null && Object.hasOwnProperty.call(message, "min_score"))
                writer.uint32(/* id 5, wireType 5 =*/45).float(message.min_score);
            return writer;
        };
        ...
        Model.decode = function decode(reader, length) {
            ...
            while (reader.pos < end) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    message.min_score = reader.float();
                    break;
                default:
        ...
        Model.verify = function verify(message) {
            ...
            if (message.min_score != null && message.hasOwnProperty("min_score"))
                if (typeof message.min_score !== "number")
                    return "min_score: number expected";
            return null;
        };
        ...
        Model.fromObject = function fromObject(object) {
            ...
            if (object.min_score != null)
                message.min_score = Number(object.min_score);
            return message;
        };
        ...
        Model.toObject = function toObject(message, options) {
            ...
            if (message.min_score != null && message.hasOwnProperty("min_score"))
                object.min_score = options.json && !isFinite(message.min_score) ? String(message.min_score) : message.min_score;
            return object;
        };
    ...
    $root.TxSyncBarrier = (function() {
    
        /**
         * Properties of a TxSyncBarrier.
         * @exports ITxSyncBarrier
         * @interface ITxSyncBarrier
         * @property {number|Long|null} [seed] TxSyncBarrier seed
         */
    
        /**
         * Constructs a new TxSyncBarrier.
         * @exports TxSyncBarrier
         * @classdesc Represents a TxSyncBarrier.
         * @implements ITxSyncBarrier
         * @constructor
         * @param {ITxSyncBarrier=} [properties] Properties to set
         */
        function TxSyncBarrier(properties) {
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
         ...
         * TxSyncBarrier seed.
         * @member {number|Long} seed
         * @memberof TxSyncBarrier
         * @instance
         */
        TxSyncBarrier.prototype.seed = $util.Long ? $util.Long.fromBits(0,0,true) : 0;
    
        /**
         * Creates a new TxSyncBarrier instance using the specified properties.
         * @function create
         * @memberof TxSyncBarrier
         * @static
         * @param {ITxSyncBarrier=} [properties] Properties to set
         * @returns {TxSyncBarrier} TxSyncBarrier instance
         */
        TxSyncBarrier.create = function create(properties) {
            return new TxSyncBarrier(properties);
        };
    
        /**
         * Encodes the specified TxSyncBarrier message. Does not implicitly {@link TxSyncBarrier.verify|verify} messages.
         * @function encode
         * @memberof TxSyncBarrier
         * @static
         * @param {ITxSyncBarrier} message TxSyncBarrier message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        TxSyncBarrier.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.seed != null && Object.hasOwnProperty.call(message, "seed"))
        ...
        /**
         * Encodes the specified TxSyncBarrier message, length delimited. Does not implicitly {@link TxSyncBarrier.verify|verify} messages.
         * @function encodeDelimited
         * @memberof TxSyncBarrier
         * @static
         * @param {ITxSyncBarrier} message TxSyncBarrier message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        TxSyncBarrier.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
    
        /**
         * Decodes a TxSyncBarrier message from the specified reader or buffer.
         * @function decode
         * @memberof TxSyncBarrier
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {TxSyncBarrier} TxSyncBarrier
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        TxSyncBarrier.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.TxSyncBarrier();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        /**
         * Decodes a TxSyncBarrier message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof TxSyncBarrier
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        TxSyncBarrier.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a TxSyncBarrier message.
         * @function verify
         * @memberof TxSyncBarrier
         * @static
         * @param {Object.<string,*>} message Plain object to verify
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        TxSyncBarrier.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.seed != null && message.hasOwnProperty("seed"))
                if (!$util.isInteger(message.seed) && !(message.seed && $util.isInteger(message.seed.low) && $util.isInteger(message.seed.high)))
        ...
        /**
         * Creates a TxSyncBarrier message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof TxSyncBarrier
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {TxSyncBarrier} TxSyncBarrier
         */
        TxSyncBarrier.fromObject = function fromObject(object) {
            if (object instanceof $root.TxSyncBarrier)
                return object;
            var message = new $root.TxSyncBarrier();
            if (object.seed != null)
                if ($util.Long)
                    (message.seed = $util.Long.fromValue(object.seed)).unsigned = true;
                else if (typeof object.seed === "string")
        ...
        /**
         * Creates a plain object from a TxSyncBarrier message. Also converts values to other types if specified.
         * @function toObject
         * @memberof TxSyncBarrier
         * @static
         * @param {TxSyncBarrier} message TxSyncBarrier
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        TxSyncBarrier.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.defaults)
        ...
        /**
         * Converts this TxSyncBarrier to JSON.
         * @function toJSON
         * @memberof TxSyncBarrier
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        TxSyncBarrier.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
    
        return TxSyncBarrier;
    })();
