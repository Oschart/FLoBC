...
do
    ...
    newtab $command_start"/Users/habibabassem/Desktop/Spring 2021/Thesis II/FDMMLS/scripts/spawn/validator_run.sh" $command_start $i
    sleep 5
done
printf "%0.s*" {1..70} 
printf "\n"
...
do
    newtab $command_start"/Users/habibabassem/Desktop/Spring 2021/Thesis II/FDMMLS/scripts/spawn/trainer_run.sh" $i
done
